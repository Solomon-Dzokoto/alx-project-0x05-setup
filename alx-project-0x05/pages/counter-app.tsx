import { useCount } from '@/context/CountContext'; // Updated import

const CounterApp: React.FC = () => {
  const { count, increment, decrement } = useCount(); // Use context
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-yellow-400 to-pink-500 flex flex-col justify-center items-center text-white">
      ...
      <div className="flex space-x-4">
        <button
          onClick={increment} // Use increment from context
        ...
        <button
          onClick={decrement} // Use decrement from context
